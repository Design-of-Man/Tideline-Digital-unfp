...
<section class="sc-section band band--alt">
  <div class="sc-wrap">
    ...
    <p class="sc-body note" data-sc-in>Google Search Console, the 32 days after launch (21 Jul &ndash; 21 Aug 2026) against the 32 before, compared weekday to weekday because the earlier window contained a weekend and the later one did not. Enquiries are counted from the site&rsquo;s own form; the previous site had no lead capture, so there is no percentage to quote. Published with the client&rsquo;s permission.</p>
  </div>
</section>
