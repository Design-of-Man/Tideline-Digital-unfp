  ...
  <div class="sc-wrap">
    <div class="split">
      <div>
        ...
        <p class="sc-body note" data-sc-in>Already a client with a billing question? Email <a href="mailto:hello@designofman.com">hello@designofman.com</a> and we will sort it out.</p>
      </div>
      <div>
