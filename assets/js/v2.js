...
(function () {
  ...
  (function () {
    ...
    // 8s walk (4K) / 3.5s reveal (the reshoot) / 3.5s push-in (4K).
    // Shots 2 and 3 are a reverse-angle pair on the same moment -- front of the
    // laptop, then from behind the men -- cut where the screen is the same size
    // in both (15.0% of frame against 13.2%), so it reads as coverage rather
    // than the camera jumping backwards.
    var CLIP_ENDS_T = [8, 11.5, 15];
    ...
    var SCREEN_TRACK = [
      [11.583, 0.46748, 0.46225, 0.13455, 0.17013],
      [11.708, 0.46438, 0.45874, 0.1403, 0.17721],
      [11.833, 0.45943, 0.45467, 0.14648, 0.18467],
      [11.958, 0.45349, 0.44946, 0.15276, 0.19202],
      [12.083, 0.447, 0.44223, 0.15956, 0.20008],
      [12.208, 0.44026, 0.43477, 0.16691, 0.20942],
      [12.333, 0.43324, 0.42818, 0.17488, 0.21907],
      [12.458, 0.42697, 0.42122, 0.18287, 0.22953],
      [12.583, 0.42131, 0.41338, 0.19128, 0.24027],
      [12.708, 0.41643, 0.40509, 0.19989, 0.25027],
      [12.833, 0.41173, 0.39478, 0.20867, 0.26169],
      [12.958, 0.40613, 0.38402, 0.21822, 0.27338],
      [13.083, 0.40038, 0.37294, 0.22773, 0.28474],
      [13.208, 0.39422, 0.36257, 0.23726, 0.2968],
      [13.333, 0.38779, 0.35336, 0.24654, 0.30837],
      [13.458, 0.38126, 0.34529, 0.25572, 0.31989],
      [13.583, 0.37502, 0.33833, 0.26474, 0.33141],
      [13.708, 0.3692, 0.3318, 0.27353, 0.34255],
      [13.833, 0.36383, 0.32531, 0.28212, 0.35342],
      [13.958, 0.35899, 0.319, 0.29019, 0.3632],
      [14.083, 0.3545, 0.31281, 0.29789, 0.37263],
      [14.208, 0.35039, 0.30629, 0.3052, 0.38188],
      [14.333, 0.3465, 0.30052, 0.31218, 0.39033],
      [14.458, 0.34303, 0.29476, 0.31859, 0.3984],
      [14.583, 0.33999, 0.28901, 0.32442, 0.40645],
      [14.708, 0.33731, 0.28423, 0.32974, 0.41315],
      [14.833, 0.33512, 0.28055, 0.33441, 0.41837],
      [14.958, 0.33358, 0.27761, 0.33773, 0.42257]
    ];
